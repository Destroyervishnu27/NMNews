...
public class GetOtherUserHashNewsAdapter extends RecyclerView.Adapter<GetOtherUserHashNewsAdapter.MyViewHolder> {
    private List<GetUserHashTagModel.DataBeanX.DataBean.PagedRecordBean> moviesList;
    Context context;

    public GetOtherUserHashNewsAdapter(Context context, List<GetUserHashTagModel.DataBeanX.DataBean.PagedRecordBean> moviesList) {
