...
public class LikesListAdapter extends RecyclerView.Adapter<LikesListAdapter.MyViewHolder> implements Callback<Object> {
    private List<LikesListModel.DataDTOX.DataDTO> moviesList;
    Context context;
    boolean isFolow;
    Rest rest;
    int folow;
    ...
    public LikesListAdapter(List<LikesListModel.DataDTOX.DataDTO> moviesList, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
       // Toast.makeText(context, "onBindViewHolder", Toast.LENGTH_SHORT).show();
        ...
        LikesListModel.DataDTOX.DataDTO movie = moviesList.get(position);
        ...
        holder.rel_folow_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                callServicegetFollows(String.valueOf(moviesList.get(folow).getUserId()), moviesList.get(folow).getFollowing());
            }
        });
    }
        ...
        if (response.isSuccessful()) {
            ...
            if (obj instanceof AddNewsModel) {
                ...
                if (loginModel.isStatus()) {
                    if (moviesList.get(folow).getFollowing()) {
                        moviesList.get(folow).setFollowing(false);
                    } else {
                        moviesList.get(folow).setFollowing(true);
                    }
