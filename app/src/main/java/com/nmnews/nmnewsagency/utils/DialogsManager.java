...
import com.nmnews.nmnewsagency.utils.qb.callback.QbEntityCallbackImpl;
...
public class DialogsManager {
    ...
    private QBChatMessage buildMessageCreatedGroupDialog(QBChatDialog dialog) {
        ...
        qbChatMessage.setBody(Application.getInstance().getString(R.string.new_chat_created, getCurrentUserName(), dialog.getName()));
    ...
    private QBChatMessage buildMessageAddedUsers(QBChatDialog dialog, String userIds, String usersNames) {
        ...
        qbChatMessage.setBody(Application.getInstance().getString(R.string.occupant_added, getCurrentUserName(), usersNames));
        qbChatMessage.setSaveToHistory(true);
        qbChatMessage.setMarkable(true);
        return qbChatMessage;
    }
    ...
    private QBChatMessage buildMessageLeftUser(QBChatDialog dialog) {
        ...
        qbChatMessage.setBody(Application.getInstance().getString(R.string.occupant_left, getCurrentUserName()));
        qbChatMessage.setSaveToHistory(true);
        qbChatMessage.setMarkable(true);
        return qbChatMessage;
    }
