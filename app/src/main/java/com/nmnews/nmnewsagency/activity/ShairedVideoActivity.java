...
import com.nmnews.nmnewsagency.chat.ChatHelper;
...
import com.nmnews.nmnewsagency.pref.SharedPrefsHelper;
...
public class ShairedVideoActivity extends AppCompatActivity implements Callback<Object> {
    ...
    private void inIt() {
        ...
        lin_ownvideo_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShairedVideoActivity.this, UserProfileActivity.class);
       ...
       /* rel_ownvideo_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShairedVideoActivity.this, UserOwnDegtailProfileActivity.class);
                startActivity(intent);
            }
        });*/
        lin_own_comnt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShairedVideoActivity.this, CommentsActivity.class);
        ...
        txt_ownlike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShairedVideoActivity.this, LikesActivity.class);
                intent.putExtra("newsId", arrayList.get(0).getNewsId());
                startActivity(intent);
            }
        });
    ...
    private void callServicegetLike(int newid) {
        // Toast.makeText(ShairedVideoActivity.this, "like", Toast.LENGTH_SHORT).show();
        rest.ShowDialogue("Please Wait ..");
        rest.likeUser1(newid);
    }

    private void callServicegetDisLike(int newid) {
        // Toast.makeText(ShairedVideoActivity.this, "dislike", Toast.LENGTH_SHORT).show();
        rest.ShowDialogue("Please Wait ..");
        ...
        if (response.isSuccessful()) {
            ...
            if (obj instanceof GetNewsByIdModel) {
                ...
                if (loginModel.isStatus()) {
                    ...
                    {
                        Toast.makeText(ShairedVideoActivity.this, "This news is Deleted by Admin", Toast.LENGTH_SHORT).show();
            ...
            if (obj instanceof ReportModelClass) {
                ...
                if (loginModel.isStatus()) {
                    // Toast.makeText(ShairedVideoActivity.this, "Report successfully added", Toast.LENGTH_SHORT).show();
            ...
            if (obj instanceof DeleteNewsByIdModel) {
                ...
                if (loginModel.isStatus()) {
                    Toast.makeText(ShairedVideoActivity.this, "News Deleted successfully ", Toast.LENGTH_SHORT).show();
                    ShairedVideoActivity.this.finish();
                }
            }
            if (obj instanceof SaveModelClass) {
                SaveModelClass loginModel = (SaveModelClass) obj;
                if (loginModel.isStatus()) {
                    Toast.makeText(ShairedVideoActivity.this, "News Unsave successfully ", Toast.LENGTH_SHORT).show();
                    ShairedVideoActivity.this.finish();
    ...
    private void setDataOnViws() {
        if(arrayList.size()>0) {
            if (arrayList.get(0).getUserType() != null && arrayList.get(0).getUserType().toString().equalsIgnoreCase("REPORTER")) {
                img_userType.setBackground(getResources().getDrawable(R.drawable.ic_group_7756));
            } else
            {
                img_userType.setBackground(getResources().getDrawable(R.drawable.ic_check));
            ...
            new Handler().post(new Runnable() {
                public void run() {
                    Glide.with(ShairedVideoActivity.this)
            ...
            txt_ownviewsqq.setText(String.valueOf(arrayList.get(0).getViewCountSuffix()));
            txt_owndatetime.setText(Utils.parseDateToddMMyyyy(arrayList.get(0).getAddedOn()));
            txt_ownlike.setText(String.valueOf(arrayList.get(0).getLikesCountSuffix()));
            txt_owncoments.setText(String.valueOf(arrayList.get(0).getCommentCountSuffix()));
    ...
    public void shareFeed() {
        Utils.shareNews(ShairedVideoActivity.this,newsId,arrayList.get(0).getTitle());

    }

    private void openDialogBoxReport() {
        Dialog dialog = new Dialog(ShairedVideoActivity.this);
        ...
        but_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (radio_group.getCheckedRadioButtonId() == -1) {
                    // Toast.makeText(ShairedVideoActivity.this, "Please select report reason", Toast.LENGTH_SHORT).show();
                    Utils.showSnakBarDialog(ShairedVideoActivity.this,rel_dialogtop,"Please select report reason",R.color.alert);
                    return;
                } else {
    ...
    public void setUrlOnSimpleExoPlayer() {
        ...
        try {
            ...
            LoadControl loadControl = new DefaultLoadControl.Builder()
                    ...
                    .setBufferDurationsMs(ShairedVideoActivity.VideoPlayerConfig.MIN_BUFFER_DURATION,
                            ShairedVideoActivity.VideoPlayerConfig.MAX_BUFFER_DURATION,
                            ShairedVideoActivity.VideoPlayerConfig.MIN_PLAYBACK_START_BUFFER,
                            ShairedVideoActivity.VideoPlayerConfig.MIN_PLAYBACK_RESUME_BUFFER)
                    .setTargetBufferBytes(-1)
                    .setPrioritizeTimeOverSizeThresholds(true).createDefaultLoadControl();
            exoPlayer = ExoPlayerFactory.newSimpleInstance(ShairedVideoActivity.this, trackSelector, loadControl);
            Uri videouri = Uri.parse(arrayList.get(0).getVideoUrl());
    ...
    public void nextACtivityzzforChat() {
        ...
        QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog result, Bundle params) {
                ...
                ChatActivity.startForResult(ShairedVideoActivity.this, REQUEST_DIALOG_ID_FOR_UPDATE, result);
            }
    ...
    public void onResultReceived(UploadNewsModel.DataBean dataBean) {
        Intent intent = new Intent(ShairedVideoActivity.this, NewVideoActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent mainIntent = new Intent(ShairedVideoActivity.this, MainActivity.class);
