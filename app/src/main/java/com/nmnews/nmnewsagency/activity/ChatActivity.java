...
import com.nmnews.nmnewsagency.adapter.AttachmentPreviewAdapter;
import com.nmnews.nmnewsagency.adapter.ChatAdapter;
import com.nmnews.nmnewsagency.chat.ChatHelper;
import com.nmnews.nmnewsagency.pref.SharedPrefsHelper;
import com.nmnews.nmnewsagency.utils.DialogsManager;
import com.nmnews.nmnewsagency.utils.OnImagePickedListener;
import com.nmnews.nmnewsagency.utils.SystemPermissionHelper;
import com.nmnews.nmnewsagency.utils.ToastUtils;
import com.nmnews.nmnewsagency.utils.listeners.AttachClickListener;
import com.nmnews.nmnewsagency.utils.listeners.MessageLongClickListener;
import com.nmnews.nmnewsagency.utils.qb.PaginationHistoryListener;
import com.nmnews.nmnewsagency.utils.qb.QbChatDialogMessageListenerImp;
import com.nmnews.nmnewsagency.utils.qb.QbDialogHolder;
import com.nmnews.nmnewsagency.utils.qb.QbDialogUtils;
import com.nmnews.nmnewsagency.utils.qb.QbUsersHolder;
import com.nmnews.nmnewsagency.utils.qb.VerboseQbChatConnectionListener;
import com.nmnews.nmnewsagency.utils.views.AttachmentPreviewAdapterView;
...
public class ChatActivity extends BaseActivity implements OnImagePickedListener, QBMessageStatusListener, DialogsManager.ManagingDialogsCallbacks {
    ...
    private ImageView attachmentBtnChat, iamge_back_msgdetail, img_mesge_chat;
    private TextView typingStatus, txt_chatwith, txt_usertag;
...
*/
    ...
    private void initViews() {
        ...
        iamge_back_msgdetail = findViewById(R.id.iamge_back_msgdetail);
        txt_chatwith = findViewById(R.id.txt_chatwith);
        txt_chatwith.setText(qbChatDialog.getName());
        ...
        img_mesge_chat = findViewById(R.id.img_mesge_chat);
        txt_usertag = findViewById(R.id.txt_usertag);
txt_usertag.setText("@"+qbChatDialog.getName().replace(" ","").toLowerCase(Locale.ROOT));
