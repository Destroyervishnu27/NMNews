...
public class FFmpegQueryExtension {
    ...
    fun addAudioOnVideo(inputVideo: String,inputAudio: String , output: String): Array<String> {
        val inputs: ArrayList<String> = ArrayList()
    ...
    fun addAudioOnVideoNew(inputVideo: String,inputAudio: String , output: String): Array<String> {
        val inputs: ArrayList<String> = ArrayList()
    ...
    fun compressor(inputVideo: String, width: Int?, height: Int?, outputVideo: String): Array<String> {
        ...
        inputs.apply {
            ...
            add("${width}x${height}")
            add("-r")
            add("${if (FRAME_RATE >= 20) FRAME_RATE - 5 else FRAME_RATE}")
            add("-vcodec")
            add("mpeg4")
            add("-b:v")
            add("150k")
